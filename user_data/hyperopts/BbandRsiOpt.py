...
class_name = 'BbandRsiOpt'


class BbandRsiOpt(IHyperOpt):
    """
    ...
    def indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(5, 35, name='rsi-value'),
            Categorical([True, False], name='rsi-enabled'),
            Categorical(['bb_lower1', 'bb_lower2', 'bb_lower3', 'bb_lower4', 'bb_middle1'], name='trigger')
        ]
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Categorical([
                         ...
                         'sell-bb_upper1',
                         'sell-bb_upper2',
                         'sell_bb_lower1'], name='sell-trigger')
        ]
